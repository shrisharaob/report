...
%\centering
\subfigure[]{
\includegraphics[scale = .45]{../figures/report/RateRemapping_CA3_bigSquare.pdf}
\label{fig:sf1}
}
\subfigure[]{
\includegraphics[scale = .45]{../figures/report/RateRemapping_CA1_bigSquare.pdf}
\label{fig:sf2}
}

\subfigure[]{
\includegraphics[scale = .45]{../figures/report/RateRemapping_CA3_linear.pdf}
\label{fig:sf3}
}
\subfigure[]{
\includegraphics[scale = .45]{../figures/report/RateRemapping_CA1_linear.pdf}
\label{fig:sf4}
}
