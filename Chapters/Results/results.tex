...
\centering
\subfigure{
\includegraphics[scale = .5]{../figures/report/CA3.bigSquare.dp.chunks.pdf}
\label{fig:pvcsf2}
}
\subfigure{
...
\centering
\subfigure[]{
\includegraphics[scale=1]{../figures/report/sampleSlopeSeqCorr.pdf}
\label{fig:sssf1}
}
\subfigure[]{
\includegraphics[scale=1]{../figures/report/PoolSeqCorr_signf.pdf}
\label{fig:sssf2}
}
\subfigure[]{
\includegraphics[scale=1]{../figures/report/SlopeDistrPrePost.pdf}
\label{fig:sssf3}
}
\caption[Sleep Sequences]{The time course of number of reliable sequences that were detected within sleep. \subref{fig:sssf1} The time course of the significant sequences in a single sleep session. The red line show the regression line. \subref{fig:sssf2}  The pooled data. The y-axis is the slope of the regression line, which was fit to the normalized histogram of number of significant sequences. The x-axis is the peak value of the normalized histogram. The size of the markers are proportional to ($1 - p Value$). Each data point is a complete sleep session. \subref{fig:sssf3} Normalized distribution of the slopes.}
\label{fig:slpseq}
\end{figure}
