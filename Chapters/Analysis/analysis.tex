...
Bayesian decoding approach was adapted to analyze candidate population events in the 2D environment. For the linear track, template matching method was employed. 
